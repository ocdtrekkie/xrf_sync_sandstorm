<?php
require_once("/opt/app/includes/variables.php");
require_once("/opt/app/includes/functions_auth.php");
require_once("/opt/app/includes/functions_db.php");
require_once("/opt/app/includes/functions_redir.php");
require_once("/opt/app/includes/functions_sec.php");
