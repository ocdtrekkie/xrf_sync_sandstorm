...
if [ ! -e /var/.db-2503.1 ]; then
    if [ ! -e /var/.db-2407.1 ]; then
        ...
        mysql --user root --database app < /opt/app/install_into_db_sync_2407.1.sql
        touch /var/.db-2407.1
    fi
    mysql --user root --database app < /opt/app/install_into_db_sync_2503.1.sql
    touch /var/.db-2503.1
fi
